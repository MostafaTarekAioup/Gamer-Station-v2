...
const handleWantToPlayIcon=()=>{
 ...
 return<div ref={lastGame}  className="game-card" key={id} onMouseEnter={()=> {setIsHover(true) ; handleFavoritsIcon() ; handlePlayedIcon() ; handleWantToPlayIcon() }} onMouseLeave={()=> setIsHover(false)} 
